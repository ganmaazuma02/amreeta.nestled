...
{
	public class SlackNotifier : WebhookBaseNotifier, INotifier
	{
		private readonly ILogger _logger = LogManager.For<SlackNotifier>();

		public SlackNotifier(IMessageBuilder<JObject> messageBuilder, IOptions options) 
		...
		{
			var request = GenerateHttpRequestMessageForWebhook(_options.Slack.WebhookUri);
